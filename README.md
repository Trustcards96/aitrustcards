...
We will release all RAG templates (health, safety, hospitality) and the Bluetooth communication specification under **Apache 2.0** after the hackathon. Community contributions are welcome – feel free to open an issue or pull request.

## 📧 Contact & Links
- **Website:** [www.aitrustcards.com](https://www.aitrustcards.com)  
- **YouTube channel:** [@aitrustcards](https://www.youtube.com/@aitrustcards)  
- **LinkedIn:** [trust-cards](https://www.linkedin.com/in/trust-cards/)  
- **Email:** chris@aitrustcards.com

## 📜 Licence
[Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0)

## 🙏 Acknowledgements
- **Google Gemma 4** – for making sovereign, private, offline AI possible.  
- **John Ferguson, MD, FACS** – for the medical governance collaboration and green/red boundary indicator.  
- **BlissMi** – for the kiosk‑to‑card conversion partnership.  
- **EkoKat superyachts** – for the live deployment.  

---

**One phone. Zero cloud. Anywhere.**  
*The AI Trust Card is the window. Gemma 4 on the phone is the brain.*
